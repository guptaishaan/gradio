    ...
    def __init__(
        ...
        *,
        ...
        Parameters:
            ...
            display_mode: the display mode of the 3D model in the scene. Can be "solid" (which renders the model as a solid object), "point_cloud", or "wireframe". For .splat files, this parameter is ignored, as those files can only be rendered as solid objects. For .ply and .obj files containing only vertex data (no faces), point cloud rendering is applied automatically.
