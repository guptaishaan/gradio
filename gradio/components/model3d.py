    ...
    def __init__(
        ...
        *,
        ...
        Parameters:
            ...
            display_mode: the display mode of the 3D model in the scene. Can be "solid" (which renders the model as a solid object), "point_cloud", or "wireframe". For .splat files, this parameter is ignored. For .ply files, setting display_mode to "point_cloud" renders them as standard point clouds using the BabylonJS renderer, which supports PLY files containing only vertex positions and colours (no face data).
