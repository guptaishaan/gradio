    ...
    def __init__(
        ...
        *,
        ...
        Parameters:
            ...
            display_mode: the display mode of the 3D model in the scene. Can be "solid" (which renders the model as a solid object), "point_cloud", or "wireframe". For .splat files, this parameter is ignored. For .ply files, set this to "point_cloud" to render point cloud data (x, y, z + color) using the standard 3D renderer instead of the Gaussian Splatting renderer.
