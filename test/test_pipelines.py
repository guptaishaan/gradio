...
def test_interface_in_blocks():
    pipe1 = transformers.pipeline(model="distilbert/distilbert-base-uncased-finetuned-sst-2-english")  # type: ignore
    pipe2 = transformers.pipeline(model="distilbert/distilbert-base-uncased-finetuned-sst-2-english")  # type: ignore
...
def test_transformers_load_from_pipeline():
    ...
    pipe = pipeline(model="distilbert/distilbert-base-uncased-finetuned-sst-2-english")  # type: ignore
